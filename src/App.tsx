...
import { ArrowRight, ArrowUp, ArrowDownLeft, Building2, HeartPulse, Globe, Facebook, Twitter, Linkedin, Instagram, Phone, Mail, MapPin, Check } from "lucide-react";
...
export default function App() {
  ...
  const [currentPage, setCurrentPage] = useState<"home" | "about-us" | "services" | "contact-us">("home");
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      // CRITICAL: Clean up GSAP and ScrollTrigger before route change to avoid DOM conflicts
      ...
      // Delay refresh until React has potentially updated the DOM
      setTimeout(() => {
  ...
  useEffect(() => {
    ...
    const sectionIds = ["services", "contact-us"];
  ...
  return (
    <main id="top" ref={containerRef} className="relative bg-black">
      <SideNav
        activeId={currentPage === "about-us" ? "about-us" : activeSection}
        isDesktop={isDesktop}
      ...
      {currentPage === "about-us" ? (
        <div key="about-us"><AboutUs logo={logo} renderMenuButton={renderMenuButton} /></div>
      ) : currentPage === "services" ? (
        <div key="services"><Services logo={logo} renderMenuButton={renderMenuButton} /></div>
      ) : currentPage === "contact-us" ? (
        <div key="contact-us"><ContactUs logo={logo} renderMenuButton={renderMenuButton} /></div>
      ) : (
        <div key="home">
          <>
            {/* Hero Section */}
            ...
            <section id="services" className="relative z-20 bg-[#004d55] text-white py-24 md:py-32 px-8 md:px-16 scroll-mt-24">
